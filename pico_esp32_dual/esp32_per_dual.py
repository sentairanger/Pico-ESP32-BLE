...
read_characteristic = aioble.Characteristic(ble_service, _BLE_READ_CHAR_UUID, read=True, write=True, notify=True, capture=True)
        ...
        try:
            async with await aioble.advertise(
                ...
                tasks = [
                        ...
                        asyncio.create_task(receive_data_task(read_characteristic)),
